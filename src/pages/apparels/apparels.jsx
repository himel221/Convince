...
const Apparels = () => {
  ...
  useEffect(() => {
    ...
    const sections = document.querySelectorAll(
      '.apparel-container .section-heading, .apparel-container .client-card, .apparel-container .product-card, .apparel-container .about-heading, .apparel-container .about-paragraph, .apparel-container .stat-card, .apparel-container .about-image, .apparel-container .testimonial-card'
    );
          ...
          <div className="video-section">
            <div className="video-frame">
              ...
              <div className="video-caption">
                <h1 className="hero-title">Welcome to Convince Apparels Ltd.</h1>
                <p className="hero-subtitle">Excellence in Fashion Manufacturing</p>
              </div>
            </div>
          </div>
        </div>
...
<section className="about-section">
  <h2 className="section-heading">About Convince Apparels Ltd.</h2>
  <div className="about-content">
    <div className="about-row">
      {/* Text on the LEFT */}
      <div className="about-text">
        <h3 className="about-heading">Leading the Way in Fashion Manufacturing</h3>
        ...
        <div className="stats-container">
          ...
          <div className="stat-card">
            <h4 className="stat-number">100K+</h4>
            <p className="stat-label">Daily Production</p>
          </div>
        </div>
      </div>
      ...
      <div className="about-image">
        ...
        <section className="products-section">
          ...
          <div className="slider-container">
            <div className="slider-track">
              ...
              {allProducts.map((product, index) => (
                <div key={`duplicate-${index}`} className="product-card">
                  <div className="product-image">
                    <img 
                      src={product.url} 
                      alt={product.name}
        ...
        <section className="clients-section">
          ...
          <p className="clients-subtitle">Trusted by leading fashion brands worldwide</p>
            ...
            <div className="testimonials-grid">
              <div className="testimonial-card">
                ...
                <p className="testimonial-text">
                  Convince Apparels has been our trusted manufacturing partner for over a decade. 
                  Their attention to detail and commitment to quality is unmatched in the industry.
                </p>
                <div className="testimonial-author">
                  <strong>Sarah Johnson</strong>
                  <span>Procurement Director, ZARA</span>
                </div>
              </div>
              ...
              <div className="testimonial-card">
                <div className="quote-mark">"</div>
                <p className="testimonial-text">
                  The level of professionalism and quality assurance at Convince Apparels 
                  exceeds our expectations. They're not just a vendor, but a true partner.
                </p>
                <div className="testimonial-author">
                  <strong>Michael Chen</strong>
                  <span>Head of Production, UNIQLO</span>
                </div>
              </div>
              ...
              <div className="testimonial-card">
                <div className="quote-mark">"</div>
                <p className="testimonial-text">
                  Working with Convince Apparels has transformed our supply chain. 
                  Their innovation and reliability are second to none.
                </p>
                <div className="testimonial-author">
                  <strong>David Miller</strong>
                  <span>Operations Manager, H&M</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Board of Directors*/}
       {/* Board of Directors Section */}
        <section className="directors-section">
          ...
          <p className="directors-subtitle">Meet the visionary leaders behind Convince Zipper & Accessories Ltd.</p>
            ...
            {directors.map((director, index) => (
              <div key={index} className="director-card">
                ...
                <div className="director-info">
                  ...
                  <p className="director-designation">{director.designation}</p>
